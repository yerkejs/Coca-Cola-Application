...
const captchaUrl = `https://testinganticorona.000webhostapp.com`// link to your captcha.html
  ...
  componentDidMount () {
    if (firebase.apps.length == 0) {
      firebase.initializeApp({
        ...
        appId: "1:944579909497:web:729834fb90c3ae7e6241a8",
        measurementId: "G-RKNF8JPBQG"
      })
    }
  }
